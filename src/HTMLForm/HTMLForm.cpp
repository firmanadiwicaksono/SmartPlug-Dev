...
String HTMLForm::pengaturanKoneksi(String target, String message, String link_pengaturan_koneksi, String link_pengaturan_pengguna, String link_logout, String wifi_ssid, String wifi_password, String mqtt_broker, String mqtt_username, String mqtt_password){
  /*
  Spesifikasi :
  ...
  */
  ...
  html += "</ul>";
  html += "</div>";
  html += "<div id=\"wb_Form1\" style=\"position:absolute;left:8px;top:36px;width:396px;height:215px;z-index:12;\">";
  html += "<form method=\"post\" action=\"";
  html += target;
  html += "\" id=\"Form1\">";
  ...
  html += "<input type=\"text\" id=\"Editbox1\" style=\"position:absolute;left:130px;top:14px;width:190px;height:26px;z-index:4;\" name=\"wifi_ssid\" value=\"";
  html += wifi_ssid;
  ...
  html += "<input type=\"password\" id=\"Editbox2\" style=\"position:absolute;left:130px;top:45px;width:190px;height:26px;z-index:2;\" name=\"wifi_password\" value=\"";
  html += wifi_password;
  html += "\" maxlength=\"32\" spellcheck=\"false\">";
  html += "<label for=\"Label2\" id=\"Label3\" style=\"position:absolute;left:10px;top:77px;width:112px;height:26px;line-height:26px;z-index:5;\">MQTT Broker</label>";
  html += "<input type=\"text\" id=\"Editbox3\" style=\"position:absolute;left:130px;top:76px;width:190px;height:26px;z-index:6;\" name=\"mqtt_broker\" value=\"";
  html+= mqtt_broker;
  html += "\" maxlength=\"32\" spellcheck=\"false\">";
  html += "<label for=\"Label2\" id=\"Label4\" style=\"position:absolute;left:10px;top:108px;width:112px;height:26px;line-height:26px;z-index:7;\">MQTT Username</label>";
  html += "<input type=\"text\" id=\"Editbox4\" style=\"position:absolute;left:130px;top:107px;width:190px;height:26px;z-index:8;\" name=\"mqtt_username\" value=\"";
  html += mqtt_username;
  html += "\" maxlength=\"32\" spellcheck=\"false\">";
  html += "<label for=\"Label2\" id=\"Label5\" style=\"position:absolute;left:10px;top:139px;width:112px;height:26px;line-height:26px;z-index:9;\">MQTT Password</label>";
  html += "<input type=\"password\" id=\"Editbox5\" style=\"position:absolute;left:130px;top:138px;width:190px;height:26px;z-index:10;\" name=\"mqtt_password\" value=\"";
  html += mqtt_password;
  html += "\" maxlength=\"32\" spellcheck=\"false\">";
...
String HTMLForm::pengaturanPengguna(String target, String message, String link_pengaturan_koneksi, String link_pengaturan_pengguna, String link_logout, String username, String password, String konfirmasi_password){
  /*
  Spesifikasi :
  ...
  */
  ...
  html += "<body>";
  html += "<div id=\"container\">";
  html += "<div id=\"wb_menu\" style=\"position:absolute;left:8px;top:0px;width:394px;height:34px;z-index:7;overflow:hidden;\">";
  html += "<ul id=\"menu\">";
  html += "<li><a href=\"";
  html += link_pengaturan_koneksi;
  ...
  html += "</ul>";
  html += "</div>";
  html += "<div id=\"wb_Form1\" style=\"position:absolute;left:8px;top:36px;width:396px;height:154px;z-index:8;\">";
  html += "<form method=\"post\" action=\"";
  html += target;
  html += "\" id=\"Form1\">";
  ...
  html += "<input type=\"text\" id=\"Editbox1\" style=\"position:absolute;left:150px;top:14px;width:190px;height:26px;z-index:4;\" name=\"username\" value=\"";
  html += username;
  html += "\" maxlength=\"32\" spellcheck=\"false\">";
  ...
  html += "<input type=\"password\" id=\"Editbox2\" style=\"position:absolute;left:150px;top:45px;width:190px;height:26px;z-index:2;\" name=\"password\" value=\"";
  html += password;
  html += "\" maxlength=\"32\" spellcheck=\"false\">";
  html += "<label for=\"Label2\" id=\"Label3\" style=\"position:absolute;left:10px;top:77px;width:124px;height:26px;line-height:26px;z-index:5;\">Konfirmasi Password</label>";
  html += "<input type=\"password\" id=\"Editbox3\" style=\"position:absolute;left:150px;top:76px;width:190px;height:26px;z-index:6;\" name=\"konfirmasi_password\" value=\"";
