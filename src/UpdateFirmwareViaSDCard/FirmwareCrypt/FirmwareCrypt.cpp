...
void FirmwareCrypt::setCallbackProcess(FIRMWARECRYPT_CALLBACK_SIGNATURE){
  /*
  Spesifikasi :
  - Prosedur ini digunakan untuk menginisialisasi pointer prosedur FIRMWARECRYPT_CALLBACK_SIGNATURE.
  */
...
void FirmwareCrypt::handleUpdate(){
  ...
  */
  ...
  if(callback != NULL){ 
    callback(WAITING_PROCESS, WAITING_PROCESS_MESSAGE, "");
  }
  ...
  if (SD.begin()) {
    ...
    if(callback != NULL){ 
      callback(READ_SDCARD, SD_CARD_DETECTED, "");
    }

    if(callback != NULL){ 
      callback(READ_FIRMWARECRYPT_FILE, WAITING_PROCESS_MESSAGE, "");
    }
    
    if(SD.exists(firmware_info_filename) == true){
      if(callback != NULL){ 
        callback(READ_FIRMWARECRYPT_FILE, FIRMWARECRYPT_FILE_EXISTS, "");
      }
      ...
      while (count > 0) {
        ...
        AES256Decrypt(buffer_firmware_info, buffer_decrypt, encrypt_key, encrypt_iv);
      ...
      if(info.parse(firmware_info_str) == true){
        if(debug_mode == true){
          ...
          if(n == buffer_check.length()){
            ...
            if(callback != NULL){ 
              callback(READ_FIRMWARECRYPT_FILE, VALID_FIRMWARECRYPT_FILE, "");
            }
            ...
            if(callback != NULL){ 
              callback(DECRYPT_AND_VERIF_HASH, WAITING_PROCESS_MESSAGE, "");
            }
            ...
            while(SD.exists(partFile(file_number)) == true){
              ...
              if(callback != NULL){ 
                callback(DECRYPT_AND_VERIF_HASH, WAITING_PROCESS_MESSAGE, partFile(file_number));
              }
              ...
              while (count > 0) {
                ...
                AES256Decrypt(buffer_firmware, buffer_decrypt, encrypt_key, encrypt_iv);
            ...
            if(n == str_hash.length()){
              ...
              if(callback != NULL){ 
                callback(DECRYPT_AND_VERIF_HASH, VALID_FIRMWARE_HASH, str_hash);
              }
              ...
              if(callback != NULL){ 
                callback(DECRYPT_AND_UPDATE_FIRMWARE, WAITING_PROCESS_MESSAGE, "");
              }
              ...
              if (Update.begin(maxSketchSpace)) {
                ...
                while(SD.exists(partFile(file_number)) == true){
                  ...
                  if(callback != NULL){ 
                  callback(DECRYPT_AND_UPDATE_FIRMWARE, WAITING_PROCESS_MESSAGE, partFile(file_number));
                  }
                ...
                if(Update.end(true) == true){
                  ...
                  if(callback != NULL){ 
                    callback(DECRYPT_AND_UPDATE_FIRMWARE, UPDATE_COMPLETE, "");
                  }
                  ...
                  if(SD.begin()){
                    ...
                    if(callback != NULL){ 
                      callback(REMOVE_SDCARD, WAITING_REMOVE_SDCARD, "");
                    }
                  ...
                  if(callback != NULL){ 
                    callback(REMOVE_SDCARD, SDCARD_REMOVED, "");
                  }
                  ...
                  if(callback != NULL){ 
                    callback(RESTART_DEVICE, WAITING_PROCESS_MESSAGE, "");
                  }
                  ...
                  if(callback != NULL){ 
                    callback(DECRYPT_AND_UPDATE_FIRMWARE, UPDATE_FAILED, "");
                  }
              ...
              if(callback != NULL){ 
                callback(DECRYPT_AND_VERIF_HASH, INVALID_FIRMWARE_HASH, "");
              }
            ...
            if(callback != NULL){ 
              callback(READ_FIRMWARECRYPT_FILE, INVALID_FIRMWARECRYPT_FILE, "");
            }
      ...
      if(callback != NULL){ 
        callback(READ_FIRMWARECRYPT_FILE, FIRMWARECRYPT_FILE_NOT_EXISTS, "");
      }
    ...
    if(callback != NULL){ 
      callback(READ_SDCARD, SD_CARD_NOT_DETECTED, "");
    }
  }
}
//------------------------------------------------------------------------------
